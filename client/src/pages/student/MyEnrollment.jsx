...
const MyEnrollment = () => {
  ...
  return (
    ...
    <div className='md:px-36 px-8 pt-10'>
        ...
        <table className='md:table-auto table-fixed w-full overflow-hidden mt-10 border'>
          ...
          {enrolledCourse.map((course,index)=>(
            <tr key={index} className='border-b border-gray-500/20'>
              ...
              <td className='px-4 py-3 max-sm:text-right'>
                <button className='px-3 sm:px-5 py-1.5 dm:py-2 bg-blue-600 max-sm:text-xs text-white' onClick={()=>navigate('/player/' + course._id)}>
