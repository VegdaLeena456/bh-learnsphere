...
const Navbar = () => {
  ...
  return (
    <div
      className={ `flex items-center justify-between px-4 sticky top-0 z-10 backdrop-blur-sm sm:px-10 md:px-14 lg:px-36 border-b border-gray-300 py-3  ${
    ...
    >
      <img onClick={()=> navigate('/')}
        src={assets.logo}
        alt="Logo"
        className="w-40 lg:w-47 cursor-pointer"
      />
