...
const SearchBar = ({data}) => {
  ...
  return (
      <form onSubmit={onSearchHandler} className='max-w-xl w-full md:h-14 h-12 flex items-center bg-white border border-gray-500/20 rounded'>
        <img src={assets.search_icon} alt="search ico" className='md:w-auto w-10 px-3' />
        ...
        <button type='submit' className='bg-blue-600 rounded text-white px-3 py-2 mx-1'>Search</button>
      </form>
  )
}
